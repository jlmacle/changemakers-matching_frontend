 ...
 */
function display_project_view(username) {
...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    if (cookie) {
        ...
        if (debug)
            console.debug("username_part = " + username_part);
 ...
 *
 */
function sign_up_data_processing(event, url) {
    let debug = true;
...
auth_form_submit === null || auth_form_submit === void 0 ? void 0 : auth_form_submit.addEventListener("click", (event) => sign_up_data_processing(event, "http://127.0.0.1:8080/representatives/new-account"));
function logout() {
    ...
    let new_account_proj_rep = document.getElementById("new-account_proj-rep");
...
logout_link === null || logout_link === void 0 ? void 0 : logout_link.addEventListener("click", logout);
logout_link === null || logout_link === void 0 ? void 0 : logout_link.addEventListener("keydown", function (event) {
